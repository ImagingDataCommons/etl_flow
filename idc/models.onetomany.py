...
class Collection_1tom(Base):
    ...
    patients = relationship("Patient_1tom", back_populates="collection", order_by="Patient_1tom.submitter_case_id", cascade="all, delete")
    # patients = relationship("Patient", backref="the_collection")

class Patient_1tom(Base):
    ...
    collection = relationship("Collection_1tom", back_populates="patients")
    studies = relationship("Study_1tom", back_populates="patient", order_by="Study_1tom.study_instance_uid", cascade="all, delete")
    # studies = relationship("Study", backref="patient")

class Study_1tom(Base):
    __tablename__ = 'study'
    min_timestamp = Column(DateTime, nullable=True, comment="Time when building this object started")
    ...
    patient = relationship("Patient_1tom", back_populates="studies")
    seriess = relationship("Series_1tom", back_populates="study", order_by="Series_1tom.series_instance_uid", cascade="all, delete")
    # series = relationship("Study", backref="study")

class Series_1tom(Base):
    ...
    study = relationship("Study_1tom", back_populates="seriess")
    instances = relationship("Instance_1tom", back_populates="seriess", order_by="Instance_1tom.sop_instance_uid", cascade="all, delete")
...
class Instance(Base):
    ...
    series = relationship("Series_1tom", back_populates="instances")
