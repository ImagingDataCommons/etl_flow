...
if __name__ == '__main__':
    ...
    parser.add_argument('--subdir', default='idc-conversion-outputs-Reconverted_uptoandincludingRound4', help="Subdirectory of mount_point at which to start walking directory")
    ...
    parser.add_argument('--exclusion_filter', default='Ineligible', help='Ignore blob name during valadation if value is in blob name')
