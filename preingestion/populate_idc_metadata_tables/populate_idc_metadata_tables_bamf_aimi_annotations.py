...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_bucket', default='aimi-annotations', help='Source bucket containing instances')
    parser.add_argument('--mount_point', default='/mnt/disks/idc-etl/aimi-annotations', help='Directory on which to mount the bucket.\
    ...
    parser.add_argument('--collection_id', default='', help='idc_webapp_collection id of the collection. This can not be the name of an analysis result.If empry string, it will look up collection_id from patient_id in blob')
    parser.add_argument('--source_doi', default='10.5281/zenodo.10081112', help='Collection DOI. Might be empty string.')
