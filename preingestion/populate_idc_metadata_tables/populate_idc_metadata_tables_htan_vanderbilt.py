...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_bucket', default='idc-htan-transfer', help='Bucket containing WSI instances')
    parser.add_argument('--mount_point', default='/mnt/disks/idc-etl/idc-htan-transfer', help='Directory on which to mount the bucket.\
                The script will create this directory if necessary.')
    parser.add_argument('--subdir', default='HTAN-V1-Converted/Converted_20220623/HTAN-V1-Feb-2022/HTAN/HTAN-Vanderbilt', help="Subdirectory of mount_point at which to start walking directory")
    parser.add_argument('--collection_id', default='HTAN-VANDERBILT', help='idc_webapp_collection id of the collection or ID of analysis result to which instances belong.')
    parser.add_argument('--wiki_doi', default='', help='Collection DOI')
    parser.add_argument('--wiki_url', default='https://humantumoratlas.org/HTA11/',\
                        help='Info page URL')
