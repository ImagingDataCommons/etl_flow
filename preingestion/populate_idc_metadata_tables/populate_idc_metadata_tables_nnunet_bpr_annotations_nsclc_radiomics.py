...
if __name__ == '__main__':
    ...
    parser.add_argument('--subdir', default='version_4/nsclc', help="Subdirectory of mount_point at which to start walking directory")
    parser.add_argument('--collection_id', default='NSCLC-Radiomics', help='idc_webapp_collection id of the collection or ID of analysis result to which instances belong.')
