...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_bucket', default='idc-conversion-outputs-icdc', help='Bucket containing WSI instances')
    parser.add_argument('--mount_point', default='/mnt/disks/idc-etl/idc-conversion-outputs-icdc', help='Directory on which to mount the bucket.\
    ...
    parser.add_argument('--collection_id', default='ICDC-Glioma', help='idc_webapp_collection id of the collection or ID of analysis result to which instances belong.')
    parser.add_argument('--wiki_doi', default='10.7937/tcia.svqt-q016', help='Collection DOI')
    parser.add_argument('--wiki_url', default='https://doi.org/10.7937/tcia.svqt-q016',\
                        help='Info page URL')
