...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_bucket', default='psn_can_segmentations', help='Source bucket containing instances')
    ...
    parser.add_argument('--source_doi', default="10.5281/zenodo.11099005", help='Collection DOI. Might be empty string.')
    parser.add_argument('--versioned_source_doi', default="10.5281/zenodo.11099006", help='Collection DOI. Might be empty string.')
    parser.add_argument('--source_url', default='https://doi.org/10.5281/zenodo.11099005',\
                        help='Info page URL')
