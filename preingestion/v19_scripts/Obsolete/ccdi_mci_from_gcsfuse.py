...
if __name__ == '__main__':
    ...
    parser.add_argument('--subdir', default='idc-conversion-outputs-mci', help="Subdirectory of mount_point at which to start walking directory")
    ...
    parser.add_argument('--source_doi', default='10.5281/zenodo.11099086', help='Collection DOI. Might be empty string.')
    parser.add_argument('--versioned_source_doi', default='10.5281/zenodo.11099087', help='Collection DOI. Might be empty string.')
