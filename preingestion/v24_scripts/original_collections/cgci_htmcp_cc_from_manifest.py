...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_bucket', default='cgci_htmcp_cc', help='Source bucket containing instances')
    ...
    parser.add_argument('--source_doi', default='10.5281/zenodo.17381404', help='Collection DOI')
    parser.add_argument('--versioned_source_doi', default='10.5281/zenodo.17381405', help='Collection DOI')
