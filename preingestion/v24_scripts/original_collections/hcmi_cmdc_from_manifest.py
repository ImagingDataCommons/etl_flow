...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_bucket', default='hcmi_cmdc', help='Source bucket containing instances')
    ...
    parser.add_argument('--source_doi', default='10.5281/zenodo.17381441', help='Collection DOI')
    parser.add_argument('--versioned_source_doi', default='10.5281/zenodo.17381442', help='Collection DOI')
