...
if __name__ == '__main__':
    ...
    parser.add_argument('--collection_id', default='CGCI-HTMCP-LC', help='collection_name of the collection or ID of analysis result to which instances belong.')
    parser.add_argument('--src_bucket', default='cgci_htmcp_lc', help='Source bucket containing instances')
    ...
    parser.add_argument('--source_doi', default='10.5281/zenodo.17381428', help='Collection DOI')
    parser.add_argument('--versioned_source_doi', default='10.5281/zenodo.17381429', help='Collection DOI')
