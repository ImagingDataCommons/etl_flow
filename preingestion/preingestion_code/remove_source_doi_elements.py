...
def remove_instances(client, args, sess):
    query = f"""
...
def remove_series(client, args, sess):
    remove_instances(client, args, sess)
...
def remove_studies(client, args, sess):
    remove_series(client, args, sess)
...
def remove_patients(client, args, sess):
    remove_studies(client, args,sess)
...
def remove_collections(client, args, sess):
    breakpoint()
    remove_patients(client, args, sess)
