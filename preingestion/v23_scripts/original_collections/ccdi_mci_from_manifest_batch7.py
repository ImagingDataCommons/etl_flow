...
if __name__ == '__main__':
    ...
    parser.add_argument('--subdir', default='idc-conversion-outputs-mci_round7', help="Subdirectory of mount_point at which to start walking directory")
    ...
    parser.add_argument('--source_url', default='https://doi.org/10.5281/zenodo.11099086',\
                            help='Info page URL')
    parser.add_argument('--versioned_source_doi', default='10.5281/zenodo.17486651', help='Collection DOI')
