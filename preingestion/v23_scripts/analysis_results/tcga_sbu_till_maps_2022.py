...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_bucket', default='til-maps-2022-2025-11-02', help='Source bucket containing instances')
    parser.add_argument('--subdir', default='', help="Subdirectory of mount_point at which to start walking directory")
    parser.add_argument('--source_doi', default='10.5281/zenodo.16966285', help='Collection DOI')
    parser.add_argument('--source_url', default='https://doi.org/10.5281/zenodo.16966285',\
                            help='Info page URL')
    parser.add_argument('--versioned_source_doi', default='10.5281/zenodo.16966286', help='Versioned collection DOI')
