...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_bucket', default='gbm-aggressiveness-maps-2025-10-30', help='Source bucket containing instances')
    parser.add_argument('--subdir', default='', help="Subdirectory of mount_point at which to start walking directory")
    parser.add_argument('--source_doi', default='10.5281/zenodo.17470190', help='Collection DOI')
    parser.add_argument('--source_url', default='https://doi.org/10.5281/zenodo.17470190',\
                            help='Info page URL')
    parser.add_argument('--versioned_source_doi', default='10.5281/zenodo.17470191', help='Versioned collection DOI')
