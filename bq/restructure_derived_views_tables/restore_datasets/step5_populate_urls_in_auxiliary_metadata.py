...
def populate_urls_in_auxiliary_metadata(args, dones):
    if f'populate_urls_in_auxiliary_metadata_{args.trg_dataset}' not in dones:
        ...
        successlogger.info(f'populate_urls_in_auxiliary_metadata_{args.trg_dataset}')
    else:
        progresslogger.info(f'Skipping populate_urls_in_auxiliary_metadata_{args.trg_dataset}')
        return
