...
# Restore data saved in BQ Time Travel
import settings
import argparse
import json
...
if __name__ == '__main__':
    ...
    parser.add_argument('--table_id_project', default="bigquery-public-data", help='Project from which to get table names')
    parser.add_argument('--table_id_dataset_prefix', default='')
    parser.add_argument('--trg_project', default="idc-source-data", help='Project to which tables are copied')
    parser.add_argument('--trg_dataset_prefix', default=f"tt_ips_", help="BQ target dataset")
