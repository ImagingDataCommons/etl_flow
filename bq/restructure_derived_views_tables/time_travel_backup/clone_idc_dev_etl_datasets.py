...
if __name__ == '__main__':
    ...
    parser.add_argument('--table_id_project', default="idc-source-data", help='Project from which to get table names')
    parser.add_argument('-table_id_dataset_prefix', default='idc_dev_etl_')
    parser.add_argument('--trg_project', default="idc-source-data", help='Project to which tables are copied')
    parser.add_argument('--trg_dataset_prefix', default=f"ide_tt_", help="BQ target dataset")
