...
# Generate the analysis_results_metadata_id_source table in BQ and PSQL from a
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sheet_name', default = 'v15', help='Sheet within spreadsheet to load')
    ...
    parser.add_argument('--table_id', default='analysis_results_descriptions', help='Table name to which to copy data')
