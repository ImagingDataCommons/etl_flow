...
if __name__ == '__main__':
    ...
    parser.add_argument('--dst_project', default=f'{settings.PDP_PROJECT}', help="Project of the resulting table")
    # parser.add_argument('--dev_bqdataset_name', default=f'idc_v{settings.CURRENT_VERSION}_dev', help='BQ dataset containing development tables')
    # parser.add_argument('--pub_bqdataset_name', default=f'idc_v{settings.CURRENT_VERSION}_pub', help='BQ dataset containing public tables')
    parser.add_argument('--trg_bqdataset_name', default=f'idc_v{settings.CURRENT_VERSION}', help='BQ dataset of resulting table')
