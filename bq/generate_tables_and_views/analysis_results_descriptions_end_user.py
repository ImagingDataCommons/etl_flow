...
# Generate the analysis_descriptions_end_user table in BQ, from a
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--spreadsheet_id', default = '1_paz_B7g5A7_PmDuhOdQ9iu-zkgFW_PMQfk-rQW9RpQ',
    ...
    parser.add_argument('--table_id', default='analysis_results_descriptions_end_user', help='Table name to which to copy data')
