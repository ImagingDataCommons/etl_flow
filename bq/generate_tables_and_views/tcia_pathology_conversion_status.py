...
schema = [
    ...
    bigquery.SchemaField('Subjects', 'INTEGER', mode='NULLABLE', description='Count of subjects'),
    bigquery.SchemaField('Images', 'INTEGER', mode='NULLABLE', description='Count of images'),
