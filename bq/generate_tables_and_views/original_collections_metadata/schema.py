...
data_collections_metadata_schema = [
    ...
    bigquery.SchemaField('ImageTypes', 'STRING', mode='REQUIRED', description='Enumeration of image type/modality'),
    ...
    bigquery.SchemaField('Updated', 'DATE', mode='REQUIRED', description='Date of ost recent update'),
