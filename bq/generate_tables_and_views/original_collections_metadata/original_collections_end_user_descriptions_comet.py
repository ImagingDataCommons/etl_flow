...
# Generate the original_collections_descriptions_end_user table in BQ, from the summaries
# in idc-comet. These summaries are markdown but may have issues. We convert to HTML and
# then back to markdown to clean them up.
import settings
import argparse
import pandas as pd
