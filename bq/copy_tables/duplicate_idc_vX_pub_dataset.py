...
# Copy an idc_dev_etl.idc_vX_pub to another version
import argparse
import json
import settings
...
args.src_dataset = f'idc_v{settings.CURRENT_VERSION-1}_pub'
args.trg_dataset = f'idc_v{settings.CURRENT_VERSION}_pub'
