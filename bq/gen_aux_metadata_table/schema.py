...
auxiliary_metadata_schema = [
    ...
    bigquery.SchemaField('source_doi', mode='NULLABLE', description='The DOI of the TCIA wiki page that describes the original collection or analysis result that containing this instance'),
