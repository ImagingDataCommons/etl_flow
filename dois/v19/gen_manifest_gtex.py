...
if __name__ == '__main__':
    ...
    parser.add_argument('--collection_id', default='gtex')
    ...
    parser.add_argument('--source_doi', default='10.5281/zenodo.11099099', help="source_doi of series to be included in the manifest")
