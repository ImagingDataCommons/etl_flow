...
if __name__ == '__main__':
    ...
    parser.add_argument('--collection_id', default='pan_cancer_nuclei_seg_dicom')
    ...
    parser.add_argument('--source_doi', default='10.5281/zenodo.11099004', help="source_doi of series to be included in the manifest")
    parser.add_argument('--versioned_source_doi', default='10.5281/zenodo.11099005', help="source_doi of series to be included in the manifest")

    args = parser.parse_args()
    print("{}".format(args), file=sys.stdout)

    for subcollection in ('TCGA-BLCA','TCGA-BRCA','TCGA-CESC','TCGA-COAD','TCGA_GBM','TCGA-LUAD','TCGA-LUSC','TCGA-PAAD',
       'TCGA-PRAD','TCGA-READ','TCGA-SKCM','TCGA-STAD','TCGA-UCEC','TCGA-UVM'):
