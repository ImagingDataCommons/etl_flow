...
if __name__ == '__main__':
    ...
    parser.add_argument('--collection_id', default='nlm_visible_human_project')
    ...
    parser.add_argument('--source_doi', default='10.5281/zenodo.12690049', help="source_doi of series to be included in the manifest")
