...
def load_BQ_from_json(client, project, dataset, table, json_rows, schema, disposition='WRITE_APPEND'):
    table_id = "{}.{}.{}".format(project, dataset, table)
...
def load_BQ_from_CSV(client, dataset, table, csv_rows, schema, disposition='WRITE_APPEND'):
