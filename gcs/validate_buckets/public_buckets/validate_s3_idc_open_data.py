...
from gcs.validate_buckets.validate_s3_bucket_mp import check_all_instances_mp
...
if __name__ == '__main__':
    ...
    parser.add_argument('--find_blobs', default=False, help='Find blobs even if found_blobs bucket is not empty')
