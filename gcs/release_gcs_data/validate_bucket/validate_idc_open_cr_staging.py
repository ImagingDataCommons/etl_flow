...
"""
Validate that th idc-open-cr-staging bucket holds the correct set of instance blobs
"""
...
def get_expected_blobs_in_bucket(args):
    ...
    AND split(gcs_url,'/')[offset(2)] = 'idc-open-cr'
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--bucket', default='idc-open-cr-staging')
