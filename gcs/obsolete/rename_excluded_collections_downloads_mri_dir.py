...
# Rename instances in previously excluded collection, MRI-DIR, that was downloaded from TCIA to disk.
...
FROM `idc-dev-etl.idc_v22_dev.all_joined`
...
if __name__ == '__main__':
    ...
    parser.add_argument('--collection_id', default='MRI-DIR', help='Collection ID to rename')
    parser.add_argument('--download_path', default='/mnt/disks/idc-etl/rename_mri_dir', help='Directory containing downloaded instances')
    args = parser.parse_args()

    bucket_name = f'idc_v24_tcia_{args.collection_id.lower().replace("-", "_").replace(" ", "_")}'
    ...
    # Generate a list of all files in the download path whose name endswith '.dcm'
    dcms = []
