...
def export_dicom_metadata(args):
    ...
    destination = f'bq://{settings.DEV_PROJECT}.{settings.BQ_DEV_EXT_DATASET}.{settings.bqtable}'
    data = {
        'bigqueryDestination': {
    ...
    url = f'https://healthcare.googleapis.com/v1/projects/{settings.GCH_DICOMSTORE}/locations/{settings.GCH_REGION}/datasets/{settings.GCH_DATASET}/dicomStores/{settings.GCH_DICOMSTORE}:export'
