...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_bucket', default='idc-dev-cr')
    parser.add_argument('--dst_bucket', default=f'idc-dev-v{args.version}-dicomstore-staging')
    parser.add_argument('--excluded_tables', default=[], help="Tables of lists of collections in other buckets to be excluded")
